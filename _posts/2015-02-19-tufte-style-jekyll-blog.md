...
In print, Tufte uses the proprietary Monotype Bembo Thus concludes my unnecessary use of em and strong for the purpose of example.
...
This is not the One True Table. Such a style does not exist. One must craft each data table with custom care to the narrative.
